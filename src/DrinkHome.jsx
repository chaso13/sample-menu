    ...
    render() {
        return (
            <div>
                ...
                <MenuItem img="/assets/blanco-tequila-resized.jpg" title="Blanco Tequila" content="Blanco is a clear tequila variety that is usually not matured, and it is never colored. Soon after distillation, it is diluted to drinking strength, and it is then immediately bottled. This tequila shows a true agave character." price="$6.00"/>
            </div>
        );
    }
}
